"""
Core functionality and constants for the Galileo framework.
"""
...
class GalileoError(Exception):
    """Base exception for Galileo framework errors."""
    pass

class DataLoadError(GalileoError):
    """Exception raised when data loading fails."""
    pass

class FeatureExtractionError(GalileoError):
    """Exception raised when feature extraction fails."""
    pass

class ModelError(GalileoError):
