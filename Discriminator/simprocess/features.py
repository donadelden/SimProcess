"""
Feature extraction and processing functions for the SimProcess framework.
"""
...
from simprocess.data import load_data, filter_data, extract_noise_signal

logger = logging.getLogger('simprocess.features')
...
def process_csv_files(data_directory, output_file=None, target_column=None, window_size=10, 
    ...
    try:
        ...
        from simprocess.core import is_numeric_column, SIGNAL_TYPES
